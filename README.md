...
## How to Use
1. Log into your Instagram if you have not done so, and go to your profile page (address should be something like this: <span>https://www.<span></span>instagram</span>.com/PROFILE_NAME/)
